...
def load_data_loader(dataset, data_dir, dataloader_config, num_workers=4):
    prepare_loaders = {
    ...
    if dataset == 'CUB':
        loaders = prepare_loaders(
            ...
            vocab_path='ProbVLM/src/ds/vocabs/cub_vocab.pkl')
    elif dataset == 'FLO':
        loaders = prepare_loaders(
            dataloader_config,
            dataset_root=data_dir,
        ...
        loaders = prepare_loaders(
            dataloader_config,
            dataset_root=data_dir,
            vocab_path='ProbVLM/src/ds/vocabs/coco_vocab.pkl',
